...
def should_include(filepath):
    ...
    allowed_files = [
        "NF_MAAgilent1ch_v" + args.workflow_version + "_GLmicroarray.html",
...
def main():
    ...
    parser.add_argument('--workflow_version', default='', help='Version of the NF_MAAgilent1ch workflow manifest')
